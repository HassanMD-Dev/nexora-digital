  ...
  return (
    <div className="relative flex items-center justify-center">
      <div className="w-full max-w-2xl overflow-hidden rounded-3xl border border-border shadow-xl hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl">
        ...
        {/* Floating Card 1 */}
        <div className="absolute top-4 left-4 md:top-8 md:left-6 z-10 flex items-center gap-3 rounded-2xl border border-border bg-background px-4 py-2 shadow-lg transition-all duration-300 hover:-translate-y-1">
